...
class Enricher
{
	...
	{
		if (empty($this->selectors) || (empty($this->backfill_styles) && empty($this->backfill_attributes) && empty($this->overwrite_styles) && empty($this->overwrite_attributes) && empty($this->add_classes) && empty($this->remove_classes))) {
			return $html;
		}
